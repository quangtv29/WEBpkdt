            ...
            modelBuilder.Entity("API.Entities.Bill", b =>
                {
                    b.Property<Guid>("Id")
                        ...
                        .HasDefaultValue(new Guid("2f4013d0-14ed-4434-950a-199a3407c3c8"));
            ...
            modelBuilder.Entity("API.Entities.Feedback", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("6bc2928b-15d0-494f-8a82-a52afae457af"));
            ...
            modelBuilder.Entity("API.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("aa6f4f0f-abd7-4bf2-8a5a-f97bb5e16773"));
            ...
            modelBuilder.Entity("API.Entities.ProductList", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("4690ebd5-8d4a-4c8b-b5a8-b83031b2cb9c"));
            ...
            modelBuilder.Entity("API.Entities.ProductType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("37fd089e-07b9-42be-bc88-a8c95a4caac1"));
            ...
            modelBuilder.Entity("API.Entities.Sale", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("347b4e34-b14a-4b87-829b-a26193c33458"));
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "6d4ad5fe-45ad-4491-aeb2-b6f836e45ffd",
                            ConcurrencyStamp = "33a32e29-f8b9-4974-9f4d-9674f5a322dc",
                            Name = "Manager",
                            NormalizedName = "MANAGER"
                        },
                        new
                        {
                            Id = "98c1f170-c5ef-45ed-8d6f-58dfdf1d22f9",
                            ConcurrencyStamp = "c827936d-04d5-44d6-8b71-1a602100dcc7",
                            Name = "Customer",
                            NormalizedName = "CUSTOMER"
                        },
                        new
                        {
                            Id = "657ca07f-248b-430a-9b0b-9b5be9f39890",
                            ConcurrencyStamp = "f3337186-a3af-4379-98af-b21f8b1b8d5d",
                            Name = "Employee",
