            ...
            modelBuilder.Entity("API.Entities.Bill", b =>
                {
                    b.Property<Guid>("Id")
                        ...
                        .HasDefaultValue(new Guid("a7be09a9-0d0c-40e3-9716-0ee393454ed1"));
            ...
            modelBuilder.Entity("API.Entities.Feedback", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("7b5f479b-354a-4497-aea6-02ec3843838a"));
            ...
            modelBuilder.Entity("API.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("b7639ff3-5666-4818-9bae-6ac456613925"));
            ...
            modelBuilder.Entity("API.Entities.ProductList", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("9d4afda6-f89d-4cd4-8ce8-ffb5da16b5b4"));
            ...
            modelBuilder.Entity("API.Entities.ProductType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("189d949a-d40a-4f35-9b60-1bb76a7bed86"));
            ...
            modelBuilder.Entity("API.Entities.Sale", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("53f44416-d853-477d-a95a-31d67370c94b"));
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1eb40834-8304-4f23-ac59-be86990b431d",
                            ConcurrencyStamp = "40280bc5-a497-421b-8478-82d5aa0a3645",
                            Name = "Manager",
                            NormalizedName = "MANAGER"
                        },
                        new
                        {
                            Id = "331dd680-0162-4548-8aaa-e4e6bf05fed4",
                            ConcurrencyStamp = "89145dea-50e2-465d-9a7f-78592d3ec70f",
                            Name = "Customer",
                            NormalizedName = "CUSTOMER"
                        },
                        new
                        {
                            Id = "934f6eb5-8215-46b1-b847-79fb92f7f897",
                            ConcurrencyStamp = "a3153deb-b158-43d7-b037-5b220066f945",
                            Name = "Employee",
